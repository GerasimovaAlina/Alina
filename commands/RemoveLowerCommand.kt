...
class RemoveLowerCommand(
    ...
    override fun execute(args: List<String>) {
        ...
        iomanager.outputLine("Удалено $count элементов, меньших чем заданный")
    }
    ...
    private fun readCityFromInput(): City {
        ...
        return City(
            ...
            creationDate = Date(),
            area = InputReader.readFloat(iomanager, "Площадь (кв. км):", null, min = 0.1f, max = 10000.0f),
    ...
    private fun readCoordinates(): Coordinates {
        iomanager.outputLine("\nКоординаты города:")
        return Coordinates(
            x = InputReader.readDouble(iomanager, "Координата X:", null),
    ...
    override fun help(): String = "remove_lower - удалить из коллекции все элементы, меньшие чем заданный"
}
